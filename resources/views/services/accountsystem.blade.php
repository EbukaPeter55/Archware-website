...
<div style=" background-image: url(../customImages/Group6700.png); background-repeat:no-repeat" class="mt-5">
        <section class="container  d-flex flex-flow flex-wrap justify-content-center align-items-center block-display-tab section-top">
            ...
            <div class="archwarejo-width-top-head ">
                <img class="img-fluid image-width-tab image-min-height-mobile" src="/customImages/Rectangle 651acaa.png">
            </div>
        </section>
    </div>
    ...
    <section class="container mt-5 d-flex flex-flow flex-wrap justify-content-center align-items-center block-display-tab">
        ...
        <p> The accuracy and extensive data generated from our system have been able to ensure that all expenses are
        ...
        <p>With the aid of our software, you can quickly modify your company's regulations and change the direction of
            your operational spending, allowing you to respond to shifting market and economic situations.We develop a
            strong tracking, monitoring, and reporting system along with practical tools & workflows to speed up your
            field operations app features.
        </p>
        </div>
    </section>
    ...
    <div class="container mt-5">
        <div class="p-5 row mobile-padding">
            ...
            <div class="col-md-4 p-3 inner-padding">
                <div class="card card-height-mobile" style="border-radius: 20px; box-shadow: 0 5px 10px #e6e6e6; height: 37em;">
                    <img src="/customImages/Rectangle 661 (7).png" class="card-img-top" alt="...">
                    <div class="card-body d-flex justify-content-center align-items-center flex-wrap p-4">
                        <div class="pt-1 text-title-mobile" style="font-weight: 700; font-size:26px; line-height: 40.3px; color: #0D2158; text-align: center;">
                        ...
                        <p class="card-text archware-text-dull"
                            style="color: #0d2158; font-size: 15px; text-align: center; margin-bottom: auto;">
                            We can create mobile apps that can help you submit and approve staff costs in real-time.
                            We develop the app to help you record receipts by taking a picture as expenses are incurred, allowing processing
                            to start right away. This way, you can remain on top of staff demands.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 p-3 inner-padding">
                <div class="card card-height-mobile" style="border-radius: 20px; box-shadow: 0 5px 10px #e6e6e6; height: 37em;">
                    <img src="/customImages/Rectangle 661 (8).png" class="card-img-top" alt="...">
                    <div class="card-body d-flex justify-content-center align-items-center flex-wrap p-4">
                        <div class="pt-1 text-title-mobile" style="font-weight: 700; font-size:26px; line-height: 40.3px; color: #0D2158; text-align: center;">
                        ...
                        <p class="card-text archware-text-dull"
                            style="color: #0d2158; font-size: 15px; text-align: center; margin-bottom: auto;">
                            We don't only let you track your account and expenses, we also make reporting easy for you.
                            Our software gives you accurate reports for real-time analysis, and operational indicators and
                            this helps to reduce the rate of fraud in an organisation.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="container mt-5 d-flex flex-flow flex-wrap justify-content-center align-items-center block-display-tab experience-body-with-pix-mobile"
        style="background: #1F3F95; border-radius: 20px 20px;">
        <div class="archwarejo-width-top">
            <img class="img-fluid image-width-tab p-5 archwarejo-image-fully-bottom image-padding-buttom" src="/customImages/Rectangle.png">
        </div>
        <div class="archware-text-justify archware-content-text archwarejo-width-bottom middle-content-padding-right experience-body-mobile">
            ...
            We develop thorough expense management systems that can integrate with your current corporate infrastructure. Also, our management
            software permits you as a manager to design rules that specify and set staff spending limitations according to a clear, unambiguous
            control strategy. Therefore, you can easily regulate transaction limits and ensure the smooth running of your business.
            </p>
        </div>
    </section>
