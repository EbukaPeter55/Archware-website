...
<a href="/contacts">
    <button type="submit" class="small-mobile-long-button col-md" style="margin-top:-5%;align-items:center; background: linear-gradient(95.08deg, #7CB142 16.79%,
                 #63A148 67.93%);box-shadow: 0px -23px 50px rgba(0, 0, 0, 0.08);border-radius: 5px;width: 529px;
