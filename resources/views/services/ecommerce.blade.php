        ...
        <div class="row">
            ...
            <div class="col-md-6 px-4">
                <p class="px-2 py-4"
                    ...
                    Social Commerce continues its meteoric rise in popularity <br>across the globe with the recent
                    prediction putting the <br> industry at the growing rate of $1.2 trillion dollars in e-<br>commerce
                    purchases by 2025.<br>

                    Social Commerce continues its meteoric rise in popularity <br>across the globe with the recent
                    prediction putting the <br> industry at the growing rate of $1.2 trillion dollars in e-<br>commer

                    <br>
                    Being the owner of a top-notch, user-friendly online store is <br>the first step in starting a highly
                    successful online business.<br> With the best technical consultation and development<br> plans, we
                    unlock the potential of e-commerce platforms to<br> provide you with a robust feature that is exclusive,
                    and <br> dependable using your preferred tools such as Drupal,<br> Magento development, WooCommerce,
                    Shopify,<br> BigCommerce.<br>
                    <br>
                    Our design and development of e-commerce websites <br>provide your business with a platform that
                    connects,<br> enriches and is responsive to all devices for unforgettable <br>customer experiences.<br>
                    A great online store design not only helps customers trust <br> your brand but also helps you stand out
                    from the <br>competition.
                ...
                <div style=" background-image: url(../customImages/Group68.png)" class="mt-5">
                    <section
                        ...
                        <div class="archwarejo-width-top-head">
                            <img class="img-fluid image-width-tab image-min-height-mobile"
                                src="/customImages/ecommerce list.png">
                        </div>
                    </section>
                </div>
                ...
                <section
                    ...
                    <div class="archware-text-justify archware-content-text archwarejo-width-bottom padding-left-desktop">
                        <p>
                            Social Commerce continues its meteoric rise in popularity across the globe with the recent
                            prediction
                            putting the industry at the growing rate of $1.2 trillion dollars in e-commerce purchases by
                            2025.
                        </p>
                        <p>
                            Being the owner of a top-notch, user-friendly online store is the first step in starting a
                            highly successful
                            online business. With the best technical consultation and development plans, we unlock the
                            potential of
                            e-commerce platforms to provide you with a robust feature that is exclusive, and dependable
                            using your
                            preferred tools such as Drupal, Magento development, WooCommerce, Shopify, BigCommerce.
                        </p>
                        <p>
                            Our design and development of e-commerce websites provide your business with a platform that
                            connects,
                            enriches and is responsive to all devices for unforgettable customer experiences.
                        </p>
                        <p>
                            A great online store design not only helps customers trust your brand but also helps you stand
                            out from the
                            competition.
                        </p>
                    </div>
                            ...
                            <div class="card card-height-mobile"
                                ...
                                <div
                                    ...
                                    <p class="archware-card-paragraph-padding card-text archware-text-dull"
                                        ...
                                        Ecommerce is an ideal way you can take your brand from a traditional store to an
                                        innovative,
                        ...
                        <div class="col-md-4 p-3 inner-padding">
                            <div class="card card-height-mobile"
                                ...
                                <div
                                    ...
                                    <p class="archware-card-paragraph-padding card-text archware-text-dull"
                                        style="color: #0d2158; font-size: 15px; text-align: center; margin-bottom: auto;">
                                        An online store is available all day, every day meaning your customers can visit
                                        your store at
                                        all times, no matter what their schedule might be. This means you can appeal to a
                                        wider range of
                            ...
                            <div class="card card-height-mobile"
                                ...
                                <div
                                    ...
                                    <p class="archware-card-paragraph-padding card-text archware-text-dull"
                                        ...
                                        Your website is one of the best marketing tools your business has.A great online
                                        store design not only help customers trust your brand but also helps you stand out
                                        ...
                                        Your website is one of the best marketing tools your business has. A great online
                                        store design
                                        not only help customers trust your brand but also helps you stand out from the
                                        competition.
