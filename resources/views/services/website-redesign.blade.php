        ...
        <div class="container justify-content-center">
            <div class="row">
                ...
                <a class="py-3" style="text-align:center;"><button
                        style="background: #1F3F95;border-radius: 4px;border:none; width:225px; height: 56px; color:#FFFFFF">Click
                        Here</button></a>
            </div>
        </div>
    </section>
    ...
    <section class="my-5 py-5">
        <div class="container justify-content-center">
            <div class="row">
                ...
                <a class="py-3" style="text-align:center;"><button
                        style="background: #1F3F95;border-radius: 4px;border:none; width:225px; height: 56px; color:#FFFFFF">Get
                        In Touch </button></a>
            </div>
        </div>
    </section>
