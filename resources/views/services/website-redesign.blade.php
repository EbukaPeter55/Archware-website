...
<section class="container mt-5 d-flex flex-flow flex-wrap justify-content-center align-items-center block-display-tab">
    ...
    <div class="archware-text-justify archware-content-text archwarejo-width-bottom padding-left-desktop">
        ...
        <p>
            ...
            objectives, and web marketing plan. We also integrate a Content Management System (CMS) as part of our
            redesigning process to help improve the quality of your website’s content.
        </p>
        <p>
            Our team of experts efficiently analyses your existing page to determine the techniques necessary to
...
<section class="my-5 py-5">
    <div class="container justify-content-center">
        <div class="row">
            ...
            <a href="/contacts" class="py-3" style="text-align:center;"><button style="background: #1F3F95;border-radius: 4px;border:none; padding:1rem 1.5rem; color:#FFFFFF">Click
                    Here</button></a>
        </div>
    </div>
</section>
...
<div style=" background-image: url(../customImages/Group72.png)" class="mt-5">
    <section class="container mt-5 d-flex flex-flow flex-wrap justify-content-center align-items-center block-display-tab section-top">
        <p class="text-label-mobile py-5" style="font-weight: 500;font-size: 25px;line-height: 34px;text-align: center;color: #FFFFFF;mix-blend-mode: normal;">
            An outstanding brand purpose becomes an inextricable part of people’s lives. We assist
            businesses to retrace, articulate and reconnect to their purpose in the world.
        </p>
    </section>
</div>
<!--END OF LET’S WORK TOGETHER-->
        ...
        <div class="card col-lg-3 mx-3 native remove-shadow-mobile" style="box-shadow:13px 13px 13px #e0e0e0;">
            ...
            <div class="archware-card-padding-left px-2 py-4">
                ...
                <p class="archware-card-paragraph-padding py-2 text-align-left-body" style="font-weight: 400;font-size: 17px;line-height: 28px;text-align: center;color: #0D2158;mix-blend-mode: normal;opacity: 0.6;">
                    We offer tech solutions to your e-commerce websites by revamping your website and
                    ensuring it is responsive to all devices. We create a consistent and smooth brand experience for
                    your business, thereby, increasing conversion rates.
                </p>
            </div>
        </div>
        <div class="card col-lg-3 mx-3 native remove-shadow-mobile" style="box-shadow:13px 13px 13px #e0e0e0 ;">
            ...
            <div class="archware-card-padding-left px-2 py-4">
                ...
                <p class="archware-card-paragraph-padding py-2 text-align-left-body" style="font-weight: 400;font-size: 17px;line-height: 28px;text-align: center;color: #0D2158;mix-blend-mode: normal;opacity: 0.6;">
                We carry out audits on your website to identify gaps that need to be bridged. We help you redesign an 
                optimized website that would rank better on the search engine’s 
                result page and is also customer-focused.
                </p>
            </div>
        </div>
        <div class="card col-lg-3 mx-3 native remove-shadow-mobile" style="box-shadow:13px 13px 13px #e0e0e0 ;">
            ...
            <div class="archware-card-padding-left px-2 py-4">
                ...
                <p class="archware-card-paragraph-padding py-2 text-align-left-body" style="font-weight: 400;font-size: 17px;line-height: 28px;text-align: center;color: #0D2158;mix-blend-mode: normal;opacity: 0.6;">
                The ever changing customers’ interests are some of the reasons your website should be updated from time to time. We test, analyze and revamp your existing website pages 
                to ensure it meets the dynamic demands of your customers and search engines indices.
                </p>
            </div>
        </div>
    </div>
