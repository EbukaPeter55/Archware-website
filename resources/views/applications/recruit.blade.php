        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                ...
                <form action="{{ route('recruit.store.web') }}" method="post" enctype="multipart/form-data" id="recruit">
                    ...
                    <div class="form-group row pt-4">
                        <div class="col-sm-6">
                            <input type="text" class="form-control @error('major_in') border border-danger @enderror"
                                id="major_in" placeholder="Major in" name="major_in" required>
                            <label style="color: #819941; font-size: .7em; font-weight: 900;">
                    ...
                    <div class="form-group row pt-5">
                        <div class="col-sm-6">
                            <label for="qc_inspection_experience">Total QC or Inspection Experience</label>
                            <div class="form-check">
