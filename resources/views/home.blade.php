        ...
        <section class="container-fluid" style="margin-top: 12%">
            <div class="row justify-content-center alignt-items-center" style="padding-left: 9%; padding-right: 9%;">
                ...
                <div class="col-md-7" style="margin-top: 5%">
                    ...
                    <p>
                        <li style="font-weight: 400;font-size: 16px;line-height: 172%;color: rgba(4, 8, 86, 0.7)";><b> Value
                        ...
                        <li style="font-weight: 400;font-size: 16px;line-height: 172%;color: rgba(4, 8, 86, 0.7)";>
                            <b>Empathy</b>: Understanding is a key to our success as a team. </li><br>
                        <li style="font-weight: 400;font-size: 16px;line-height: 172%;color: rgba(4, 8, 86, 0.7)";>
                ...
                <div class="col-md-7 pt-5 px-3">
                    ...
                    <form>
                        ...
                        <div class="px-3">
                            ...
                            <input class="section6-form4" style="padding: 10px;opacity:70%;border: 1px solid #D2D6DA"
                                type="email" placeholder="hello@dummie.com">
                            <p>
                        </div>
                        <div class="px-3">
                            <label style="font-weight: 500;font-size: 14px;color: #040856">Service you are interested
                                in</label>
                            <input class="section6-form4" style="padding: 10px;opacity:70%;border: 1px solid #D2D6DA"
                                type="email" placeholder="e.g. Web Development">
                            <p>
                        </div>
                        <div class="px-3">
                            <label style="font-weight: 500;font-size: 14px;color: #040856">What can we help you with?
                            </label>
