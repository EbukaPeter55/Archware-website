...
<div class="container-fluid">
    ...
    <section class="container justify-content-center" style="margin-top: 12%">
        ...
        border-radius: 21px;">
            <div>
                <h1 class="row justify-content-center pt-5" style="font-weight: 700;font-size: 35px; line-height: 116%;text-align: center;color: #FFFFFF;">
                    Subsidiaries</h1>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 pt-5 px-3">
                ...
                <form method="post" action="{{ route('contact.message') }}">
                    ...
                    <div class="px-3">
                        <label name="helpnote" style="font-weight: 500;font-size: 14px;color: #040856">What can we help you with?
                        </label>
