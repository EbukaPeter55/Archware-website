...
@section('content')
    ...
    <section class="container-fluid  proof-of-work">
        <div class="d-md-flex flex-wrap proof-of-work-child justify-content-around web-pow">
            ...
            <div class="web col-md-3 pow-web">
                ...
                <p class="pow-body website-number completed-p" style="margin-left: 0px ; text-align:center">Completed
                    Projects</p>
            </div>
        ...
        <div class="d-sm-flex flex-row flex-wrap align-items-center justify-content-evenly support-section">
            ...
            <div class="support-section-right text-and-pictures">
                ...
                <p class=""
                    ...
                    A major concern for most businesses is to ensure they obtain value for every spend. With our automated
                    expense management software,
                    tracking your operational expenses is made easy. The accuracy of our system's extensive data helps
                    ensure that all expenses are
                    accounted for and accurate reimbursement claims are made to prevent fraud.</p>
                <a href="/account-expense-system"><button type='button' class="read-more small-mobile-long-button">Read
                        More </button> </a>
            </div>
        </div>
    </section>
                ...
                <div class="d-sm-flex flex-row flex-wrap justify-content-evenly align-items-center aboutus-left"
                    ...
                    <div class="about-left-child about-us-flex">
                        ...
                        <p class="section3-text2">
                            Archware Technologies is a renowned technologies company that delivers innovative, customized
                            and scalable
                            digital solutions to individuals and organizations across multiple industries and platforms.
                            As a groundbreaking and reliable tech company for top-tier and emerging businesses, we provide
                            critical support through
                            innovative technology offerings that propel our clients' businesses on a continuous growth
                            trajectory.
                            Our team (software engineers, data scientists, designers, and product managers) aggregates
                            decades of industry experience
                            and focuses extensively on developing scalable and world-class software that provides end-to-end
                            solutions for our clients.
                            At Archware Technologies, innovation, efficiency, ease of use,
                            and sustainability are the building blocks of our solutions.
                            For these, we earned the trust of our clients as a dependable
                            ally.
    ...
    <section class="container-fluid mission" style="margin-top: 10%">
        <div class="row justify-content-center alignt-items-center mission-wrapper"
            ...
            <div class="col-md-7" style="margin-top: 5%">
                <h1 class="mission-titles px-2"
                    style="font-weight: 700;font-size: 35px;line-height: 42px;color: #040856;">Our Mission</h1>
                ...
                <h1 class="mission-titles px-2"
                    style="font-weight: 700;font-size: 35px;line-height: 42px;color: #040856;">Our Vision</h1>
                <p class="px-2" style="font-weight: 400;font-size: 16px;line-height: 172%;color: rgba(4, 8, 86, 0.7);">
                    To become a
                    leading technology solution provider in Africa.</p>
                <h1 class="mission-titles px-2"
                    style="font-weight: 700;font-size: 35px;line-height: 42px;color: #040856;">Our Core Values</h1>
                <p>
                <ul>
                    <li class="vceir"
                        style="font-weight: 600;font-size: 16px;line-height: 172%;color: rgba(4, 8, 86, 0.7)" ;>
                        Value
                        Creation
                    </li><br>
                    <li class="vceir"
    ...
    <section class="container-fluid contact-us-wrapper" style="margin-top: 12%; margin-bottom: 9%">
        <div class="row contact-form-section">
            ...
            <div class="contact-info col-md-5 col-sm-6 contact-information-colum"
                ...
                <div class="sec6itext">
                    ...
                    <div class="pt-3 mx-5">
                        <p><img class=info_arch1 src="{{ asset('customImages/Phone Icon.svg') }}" alt="">
                            <a style="font-weight: 400;font-size: 14px;color: #FFFFFF;">+234-807-266-3033,
                                +234-912-207-4233</a>
                        </p>
