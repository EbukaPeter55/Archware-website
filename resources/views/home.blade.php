    ...
    <div class="container">
        <section>
            <div class="row justify-items-center">
                <div class="col-md-8" style="color: rgba(4, 8, 86, 0.7);">
                    <h1 class="pt-4" style="font-weight: 700;font-size: 50px;"><b>Excellent Tech-Based <br>Solution For Your
                            <br>Business</b></h1>
                    <p class="pt-4" style="font-weight: 400;font-size: 16px;">our agile approach to problem solving helps
                        you build a better result and achieve
        ...
        <section class="pt-5">
            <div class="row">
                ...
                <div class="col-md-6 px-4">
                    <div class="py-2 px-2" style="font-weight: 700;font-size: 35px;line-height: 42px;color: #040856"> We
                        Provides Support For Public And Private Enterprise</div>
                    <div class="py-2 px-2"
                        style="font-weight: 400;font-size: 16px;line-height: 172%;color: rgba(4, 8, 86, 0.7);">Archwareltd
        ...
        <section>
            <div class="section3">
                <div
                    style="padding-left: -1000px;width: 1288px;height: 446px;background: linear-gradient(90.18deg, #A6CE39 -27.2%, #0A655F 248.97%);border-radius: 21px;">
                    <div class="sec3">
                        <div>
                            <h1 class="section3-text1">About Us</h1>
                            <p class="section3-text2">Archware Tech Group is a result-driven tech company in Lagos, Nigeria,
                                established to
                                provide technological
                                innovations that help improve the quality of work and lives of people across several
                                business sectors.
                                We are a team of creative thinkers that render excellent services that add value to you and
                                your
                                business. Our
                                company comprises five subsidiaries created to contribute to the technological enhancement
                                of different
                                business
                                sectors in Africa.</p>
                        </div>
            ...
            <div class="sec4texts">
                ...
                <div>
                    ...
                    <div class="sec4t6">
                        ...
                        <li><b>Innovation</b>: We are more than simply a team; we are innovative thinkers that strive to
                            provide
                            fresh concepts.</li><br>
                        <li><b>Resilience</b>: We do not believe in defeat. We're a team of resilient individuals who
                            persevere
                ...
                <div class="sec6itext">
                    <div>
                        <h1 class="section6-text3">Contact Information<h1>
                                <p class="section6-text4">Fill up the form and our Team will get back to you within 24
                                    hours.</p>
                    </div>
                    ...
                    <div>
                        <p>
                        <p>
                        <p class="phno"><img class=info_arch1 src="{{ asset('customImages/Phone Icon.svg') }}"
                                alt="">

                            <b class=info_arch1B>+234709154822</b>
                        </p>
                        <p class="phno"><img id=info_arch2 src="{{ asset('customImages/Envelope Icon.svg') }}"
                                alt="">
                            <a id=info_arch2B>info@archwareltd.com</a>

                        </p>
                        <p class="phno"><img id=info_arch3 src="{{ asset('customImages/Map Marker Icon.svg') }}"
                                alt="">
